...
if (isset($_REQUEST['update'])) {
    $sql = "UPDATE foods SET food_name=:food_name, food_price=:food_price, food_detail=:food_detail, food_status=:food_status, food_image=:image_base64, update_at=CURRENT_TIMESTAMP WHERE food_id=$food_id";
