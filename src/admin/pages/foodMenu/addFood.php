...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO foods (food_name, food_price, food_detail, food_status, create_at, food_image)
  VALUES (:food_name, :food_price, :food_detail, :food_status, CURRENT_TIMESTAMP, :image_base64)";
