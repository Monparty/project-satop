...
foreach ($stmt as $i=>$fetch) {
  ...
  // แสดงผลรูปภาพ
  $showimg[$i] = '<img src="data:$meetroom_image/png;base64,' . $image_base64[$i] . '" style="width: 100%; height: 310px; object-fit: cover; border-radius: 4px; transition: .3s;"/>';
}
...
include ("userMeetBookingDetail.html");
?>
